...
PLACES are to be taken in ORDER, which is passed as the second argument to sort.
Each of PLACES is marked by putting an overlay on it, with an after-text generated by
